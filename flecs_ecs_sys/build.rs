...
fn main() {
    ...
    #[cfg(not(feature = "disable_build_c"))]
    {
        ...
        if std::env::var("TARGET").unwrap() == "wasm32-unknown-unknown" {
            ...
            build.define("BULK_MEMORY_THRESHOLD", Some("32"));
            build
                .include(&Path::new("wasm-sysroot/src/internal")) // Internal can override non-internal
                .include(&Path::new("wasm-sysroot/include"))
                .include(&Path::new("wasm-sysroot/arch/wasm32"))
                .file(&Path::new("wasm-sysroot/src/ctype/tolower.c"))
                .file(&Path::new("wasm-sysroot/src/ctype/toupper.c"))
                .file(&Path::new("wasm-sysroot/src/math/__fpclassifyl.c"))
                .file(&Path::new("wasm-sysroot/src/prng/rand.c"))
                .file(&Path::new("wasm-sysroot/src/stdio/printf.c"))
                .file(&Path::new("wasm-sysroot/src/stdio/snprintf.c"))
                .file(&Path::new("wasm-sysroot/src/stdio/vfprintf.c"))
                .file(&Path::new("wasm-sysroot/src/stdio/vsnprintf.c"))
                .file(&Path::new("wasm-sysroot/src/stdio/vsprintf.c"))
                ...
                .file(&Path::new("wasm-sysroot/src/stdlib/qsort.c"))
                .file(&Path::new("wasm-sysroot/src/stdlib/qsort_nr.c"))
