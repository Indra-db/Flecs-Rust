    ...
    T: QueryTuple,
{
    ...
    pub fn set_group_id(&self, group_id: impl Into<Entity>) -> QueryIter<(), T> {
    ...
    /// * C++ API: `iter_iterable::set_group`
    #[doc(alias = "iter_iterable::set_group")]
    pub fn set_group<Group: ComponentId>(&self) -> QueryIter<(), T> {
        let mut iter = self.iterable();
    ...
    pub fn set_var(&self, var_id: i32, value: impl Into<Entity>) -> QueryIter<(), T> {
        let mut iter = self.iterable();
    ...
    pub fn set_var_table(&self, var_id: i32, table: impl IntoTableRange) -> QueryIter<(), T> {
        let mut iter = self.iterable();
    ...
    /// * C++ API: `iter_iterable::set_var`
    #[doc(alias = "iter_iterable::set_var")]
    pub fn set_var_expr(&self, name: &str, value: impl Into<Entity>) -> QueryIter<(), T> {
        let mut iter = self.iterable();
    ...
    /// * C++ API: `iter_iterable::set_var`
    #[doc(alias = "iter_iterable::set_var")]
    pub fn set_var_table_expr(&self, name: &str, table: impl IntoTableRange) -> QueryIter<(), T> {
        let mut iter = self.iterable();
