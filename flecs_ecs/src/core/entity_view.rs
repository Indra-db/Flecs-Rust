...
use super::{
    ...
    c_binding::bindings::{
        ...
        ecs_get_table, ecs_get_target, ecs_get_type, ecs_has_id, ecs_is_alive, ecs_is_enabled_id,
        ecs_is_valid, ecs_iter_t, ecs_lookup_path_w_sep, ecs_new_id, ecs_owns_id, ecs_record_find,
        ecs_record_t, ecs_search_offset, ecs_table_get_type, ecs_table_t, ecs_term_t, EcsAny,
        EcsChildOf, EcsDisabled, EcsIsEntity, EcsPrefab, EcsUnion, EcsWildcard, ECS_FILTER_INIT,
    },
    c_types::*,
