...
use crate::{
    ...
    sys::{
        ecs_entity_t,
        ecs_filter_t, ecs_flags32_t, ecs_id_t, ecs_inout_kind_t,
        ecs_inout_kind_t_EcsIn, ecs_inout_kind_t_EcsInOut, ecs_inout_kind_t_EcsInOutDefault,
        ecs_inout_kind_t_EcsInOutNone, ecs_inout_kind_t_EcsOut, ecs_iter_t, ecs_observer_t, ecs_oper_kind_t, ecs_oper_kind_t_EcsAnd,
        ecs_oper_kind_t_EcsAndFrom, ecs_oper_kind_t_EcsNot, ecs_oper_kind_t_EcsNotFrom,
        ecs_oper_kind_t_EcsOptional, ecs_oper_kind_t_EcsOr, ecs_oper_kind_t_EcsOrFrom, ecs_primitive_kind_t, ecs_query_group_info_t,
        ecs_query_t, ecs_ref_t, ecs_rule_t, ecs_table_t, ecs_term_id_t,
